...
/// Deux parcours transverses : la synchronisation des favoris entre deux
/// onglets, et le changement de langue à chaud.
///
/// Le premier est celui qui casse le plus facilement : le catalogue et
/// l'écran Favoris lisent le même `FavoritesController`, mais chacun via un
/// chemin différent (`context.select` par carte d'un côté, `watch` de l'autre).
void main() {
  ...
  testWidgets(
      'changer la langue depuis le profil retraduit toute '
    ...
    // Le sélecteur de langue est un DropdownButton.
